...
- Renamed project from `ukidama` to `ukiapi`
- Updated all package names: `ukiapi`, `ukiapi-macros`
- Updated environment variables: `UKIAPI_HOST`, `UKIAPI_PORT`
- Updated CLI banners and help text to reference UkiApi
- Version reset to 0.0.1 due to name change
...
- Deleted `STATE_OF_THE_ART.md`
- Removed AI restriction policy from AGENTS.md
...
- Compile-time zero-boilerplate route autodiscovery and merging
- Integrated authentication and authorization helpers with JWT-based custom claim extraction
